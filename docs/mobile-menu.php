        ...
        <div class="mm-body">
            <div data-index="1" class="mm-panel mm-panel-active">
                <ul>
                    ...
                    <li><a href="#">Another Menu Item</a><span data-target="2" class="next"><i class="icon-arrow-right"></i></span></li>
                    <li><a href="#">Plus This One</a><span data-target="3" class="next"><i class="icon-arrow-right"></i></span></li>
                    <li><a href="#">That's Four Now</a></li>
                    <li><a href="#">Shall We Continue?</a><span data-target="4" class="next"><i class="icon-arrow-right"></i></span></li>
                    <li><a href="#">Ok, Last One</a></li>
                </ul>
            </div><!-- .mm-panel -->
